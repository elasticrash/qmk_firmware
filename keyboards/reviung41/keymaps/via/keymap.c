...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_reviung41(
    ...
    KC_LCTL,              KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,               KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  RSFT_T(KC_ENT),
                                            KC_LGUI,   MO(_RAISE),    KC_SPC,   MO(_LOWER),    LT(3, KC_RALT)
  ),
  ...
  [_ADJUST] = LAYOUT_reviung41(
    RGB_VAI,   RGB_SAI, RGB_HUI,  KC_7,  KC_8,   KC_9,            XXXXXXX,  XXXXXXX,  KC_UP,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,   RGB_SAD, RGB_HUD,  KC_4,  KC_5,   KC_6,            XXXXXXX,  KC_LEFT,  KC_DOWN,  KC_RGHT,  XXXXXXX,  XXXXXXX,
    RGB_TOG,   RGB_VAD, XXXXXXX,  KC_1,  KC_2,   KC_3,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
